...
(MEMORYID, TITLE, DESCRIPTION,MEMORYLOCATION,DATEM, PRIVACY, MAINPICTURE)
values
(5, 'Parlamentul European', 'Am votat legi astazi! iuhuuu', 'Strasbourg', TO_DATE('17/03/2013', 'dd/mm/yyyy'),'public','assets/images/memory/memory5.jpg');
...
(MEMORYID, TITLE, DESCRIPTION,MEMORYLOCATION,DATEM, PRIVACY, MAINPICTURE)
values
(8, 'Briose', 'De 1 martie le-am facut baietilor briose! Sper sa le placa', 'Iasi', TO_DATE('01/03/2016', 'dd/mm/yyyy'),'public','assets/images/memory/memory8.jpg');

insert into memory 
(MEMORYID, TITLE, DESCRIPTION,MEMORYLOCATION,DATEM, PRIVACY, MAINPICTURE)
values
(9, 'Majorat', 'Astazi prietena noastra a implinit 18 ani! A fost o petrecere minunata! La multi ani!!!!!', 'Iasi', TO_DATE('18/06/2017', 'dd/mm/yyyy'),'public','assets/images/memory/memory9.jpg');

insert into memory
(MEMORYID, TITLE, DESCRIPTION,MEMORYLOCATION,DATEM, PRIVACY, MAINPICTURE)
values
(10, 'Absolvire <3', 'Am absolit liceul! A fost o zi plina de emotii', 'Iasi', TO_DATE('14/02/2016', 'dd/mm/yyyy'),'public','assets/images/memory/memory10.jpg');